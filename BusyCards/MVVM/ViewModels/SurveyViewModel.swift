...
class SurveyViewModel: ObservableObject {
    @Published var questions: [SurveyQuestion] = [
        ...
        SurveyQuestion(
            ...
            options: ["يستخدم عبارات مثل انظر ويصف تفاصيل بصرية.","يستخدم عبارات مثل اسمع ويهتم بنقل ما سمعه","يروي القصة بتسلسل منطقي ويهتم بالتفاصيل النصية","يستخدم حركات اليدين ويتحرك أثناء الشرح"]
        ),
        SurveyQuestion(
